    ...
    <div class="contenido-principal flex-grow-1">
        ...
        <div class="container py-4">
            ...
            <div class="modal fade" id="crearModal">
                <div class="modal-dialog">
                    {{-- ✅ FIX 1: Cambiado de devolucion.store → devolucion.storeEm --}}
...
<script>
    {{-- ✅ FIX 2: Cambiado de detalledevolucion.index → detalledevolucion.indexEm --}}
    const urlDetalleDevolucion = "{{ route('detalledevolucion.indexEm') }}";

    {{-- ✅ FIX 3: El fetch ahora apunta a la ruta de empleado /empleado/devolucion/{id}/detalles --}}
