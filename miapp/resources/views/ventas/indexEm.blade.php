...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formVenta.addEventListener('submit', function(e) {
        console.log('🔵 Submit interceptado. Cliente validado:', clienteValidado);
        ...
        if (!clienteValidado) {
            e.preventDefault();
            console.log('⚠️ Cliente no validado, buscando...');
            alert('Por favor espere mientras validamos el cliente');
            buscarCliente(documento);
            return false;
        }
    ...
    function mostrarFormularioNuevoCliente() {
        console.log('⚠️ Cliente no encontrado, mostrar formulario');
        ...
        clienteValidado = true;
        console.log('✅ Formulario nuevo cliente validado:', clienteValidado);
    }
