    ...
    <div class="barra-lateral d-flex flex-column flex-shrink-0 p-3 bg-primary text-white">
        ...
        <div class="menu-barra-lateral">
            <div class="seccion-menu">
                ...
                <a href="<?php echo e(route('devolucion.indexEm')); ?>" class="elemento-menu activo">
        ...
        <div class="container py-4">
            ...
            <div class="table-responsive mt-4">
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $devolucion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($dev->ID_Devolucion); ?></td>
                            <td><?php echo e($dev->Fecha_Devolucion); ?></td>
                            <td><?php echo e($dev->Motivo); ?></td>
                            <td>
                                <button class="btn btn-info btn-sm" 
                                        onclick="abrirDetalleModal(<?php echo e($dev->ID_Devolucion); ?>)">
                                    <i class="fa fa-eye"></i>
                                </button>

                                <button class="btn btn-warning btn-sm"
                                        data-bs-toggle="modal"
                                        data-bs-target="#editarModal<?php echo e($dev->ID_Devolucion); ?>">
                                    <i class="fa fa-edit"></i>
                                </button>

                                <button class="btn btn-danger btn-sm"
                                        data-bs-toggle="modal"
                                        data-bs-target="#eliminarModal<?php echo e($dev->ID_Devolucion); ?>">
                        ...
                        <!-- Modal Editar -->
                        <div class="modal fade" id="editarModal<?php echo e($dev->ID_Devolucion); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('devolucion.updateEm')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="ID_Devolucion" value="<?php echo e($dev->ID_Devolucion); ?>">
                                    <div class="modal-content">
                                        <div class="modal-header bg-warning">
                                            <h5 class="modal-title">Editar Devolución #<?php echo e($dev->ID_Devolucion); ?></h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <label>Fecha Devolución</label>
                                            <input type="date" name="Fecha_Devolucion" class="form-control mb-3"
                                                   value="<?php echo e($dev->Fecha_Devolucion); ?>"
                                                   min="<?php echo e(date('Y-m-d', strtotime('-5 days'))); ?>"
                                                   max="<?php echo e(date('Y-m-d')); ?>" required>
                                            <label>Motivo</label>
                                            <textarea name="Motivo" 
                                                      class="form-control" 
                                                      rows="3" 
                                                      required><?php echo e($dev->Motivo); ?></textarea>
                                        </div>
                        ...
                        <!-- Modal Eliminar -->
                        <div class="modal fade" id="eliminarModal<?php echo e($dev->ID_Devolucion); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('devolucion.destroyEm')); ?>">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning">
                                                <strong>Fecha:</strong> <?php echo e($dev->Fecha_Devolucion); ?><br>
                                                <strong>Motivo:</strong> <?php echo e($dev->Motivo); ?>
            ...
            <div class="modal fade" id="crearModal">
                <div class="modal-dialog">
                    <form method="POST" action="<?php echo e(route('devolucion.storeEm')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="modal-content">
...
<script>
const urlDetalleDevolucion = "<?php echo e(route('detalledevolucion.indexEm')); ?>";
...
async function iniciarExportacion() {
    ...
    try {
        ...
        const info = XLSX.utils.aoa_to_sheet([
            ...
            ['Generado por:', '<?php echo e(session("nombre") ?? "Empleado"); ?>']
        ]);
...
</html><?php /**PATH C:\Users\rnico\laraveeeeee\miapp\resources\views/devolucion/indexEm.blade.php ENDPATH**/ ?>