    ...
    <div class="barra-lateral d-flex flex-column flex-shrink-0 p-3 bg-primary text-white">
        ...
        <div class="menu-barra-lateral">
            <div class="seccion-menu">
                <a href="<?php echo e(route('InicioE.index')); ?>" class="elemento-menu">
                    <i class="fa-solid fa-tachometer-alt"></i><span>Dashboard</span>
                </a>
                <a href="<?php echo e(route('ventas.indexEm')); ?>" class="elemento-menu activo">
                    <i class="ri-price-tag-3-line"></i><span>Ventas</span>
                </a>
                <a href="<?php echo e(route('devolucion.indexEm')); ?>" class="elemento-menu">
                    <i class="ri-arrow-go-back-line"></i><span>Devoluciones</span>
                </a>
            </div>
            <hr>
            <div class="seccion-menu">
                <a href="<?php echo e(route('productos.indexEm')); ?>" class="elemento-menu">
                    <i class="ri-box-3-line"></i><span>Productos</span>
                </a>
                <a href="<?php echo e(route('clientes.indexEm')); ?>" class="elemento-menu">
    ...
    <div class="contenido-principal flex-grow-1">
            ...
            <div class="container-fluid">
                ...
                <div class="dropdown ms-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                        <li><a class="dropdown-item" href="<?php echo e(route('perfilEm')); ?>">Mi perfil</a></li>
        ...
        <div class="container py-4">
            ...
            <?php if(session('mensaje')): ?>
                <div id="alertaMensaje" class="alert alert-success text-center mt-3"><?php echo e(session('mensaje')); ?></div>
            ...
            <?php if(session('error')): ?>
                <div id="alertaError" class="alert alert-danger text-center mt-3"><?php echo e(session('error')); ?></div>
                ...
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $ventas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><?php echo e($venta->Documento_Cliente); ?></td>
                            <td><?php echo e($venta->Documento_Empleado); ?></td>
                            <td>
                                <button class="btn btn-info btn-sm" onclick="abrirDetalleModal(<?php echo e($venta->ID_Venta); ?>)">
                                    <i class="fa fa-eye"></i>
                                </button>
                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#eliminarModal<?php echo e($venta->ID_Venta); ?>">
                                    <i class="fa fa-trash"></i>
                                </button>
                            </td>
                        </tr>

                        <div class="modal fade" id="eliminarModal<?php echo e($venta->ID_Venta); ?>" tabindex="-1">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('ventas.destroyEm')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <input type="hidden" name="ID_Venta" value="<?php echo e($venta->ID_Venta); ?>">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning mt-3">
                                                <strong>ID Venta:</strong> <?php echo e($venta->ID_Venta); ?><br>
                                                <strong>Cliente:</strong> <?php echo e($venta->Documento_Cliente); ?><br>
                                                <strong>Empleado:</strong> <?php echo e($venta->Documento_Empleado); ?>
            ...
            <div class="modal fade" id="crearModal" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="<?php echo e(route('ventas.storeEm')); ?>" id="formVenta">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <div class="position-relative">
                                        <input type="text" id="buscarCliente" name="Documento_Cliente"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="Documento_Empleado" class="form-control"
                                           value="<?php echo e(session('documento')); ?>" readonly>
...
<script>
const urlDetalleVentas = "<?php echo e(route('detalleventas.indexEm')); ?>";
...
async function importarDesdeExcel(event){
    ...
    try{
        ...
        let detalles=[];
        if(workbook.SheetNames.length>1){const hojaDet=workbook.Sheets[workbook.SheetNames[1]];detalles=XLSX.utils.sheet_to_json(hojaDet).map(normalizarClaves);}
        ...
        for(let i=0;i<ventas.length;i++){
            ...
            for(const det of detsFila){
                ...
                detallesValidados.push({Nombre_Producto:nombreProducto,Cantidad:cantidad,Fecha_Salida:fechaSalida});
            }
            datosValidados.push({Documento_Cliente:docCliente,Nombre_Cliente:nombreCliente,Apellido_Cliente:apellidoCliente,Estado_Cliente:estadoCliente,Documento_Empleado:docEmpleado,detalles:detallesValidados});
        }
...
async function iniciarExportacion(){
    ...
    try{
        ...
        const hoja1=todosLosDatos.map(v=>{const nombreCompleto=v.Nombre_Cliente||'';const partes=nombreCompleto.trim().split(' ');let nombre='',apellido='';if(partes.length===1){nombre=partes[0];}else if(partes.length>=2){nombre=partes[0];apellido=partes.slice(1).join(' ');}return{'Documento Cliente':v.Documento_Cliente,'Nombre Cliente':nombre,'Apellido Cliente':apellido,'Documento Empleado':v.Documento_Empleado};});
        const hoja2=[];todosLosDatos.forEach(v=>{(v.detalles||[]).forEach(d=>{hoja2.push({'Nombre Producto':d.Producto,'Cantidad':d.Cantidad,'Fecha Salida':d.Fecha_Salida});});});
        const wb=XLSX.utils.book_new();
        const ws1=XLSX.utils.json_to_sheet(hoja1);ws1['!cols']=[{wch:18},{wch:20},{wch:20},{wch:18}];XLSX.utils.book_append_sheet(wb,ws1,'Ventas');
        if(hoja2.length>0){const ws2=XLSX.utils.json_to_sheet(hoja2);ws2['!cols']=[{wch:30},{wch:10},{wch:15}];XLSX.utils.book_append_sheet(wb,ws2,'Detalles');}
        const info=XLSX.utils.aoa_to_sheet([['REPORTE DE VENTAS - TECNICELL RM'],[''],['Fecha:',new Date().toLocaleString('es-ES')],['Total Ventas:',todosLosDatos.length],['Total Detalles:',hoja2.length],['Usuario:','<?php echo e(session("nombre") ?? "TECNICELL RM"); ?>']]);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formVenta.addEventListener('submit', function(e) {
        if (!clienteValidado) { e.preventDefault(); return false; }
    });
    ...
    function buscarCliente(documento) {
        ...
        fetch(`/empleado/api/buscar-cliente/${documento}`)
            ...
            .then(data => {
                ...
                if (data.encontrado && data.cliente) { mostrarClienteEncontrado(data.cliente); }
                else { mostrarFormularioNuevo(); }
            })
            .catch(() => { spinnerBusqueda.style.display = 'none'; mostrarFormularioNuevo(); });
    }
...
<?php /**PATH C:\Users\rnico\laraveeeeee\miapp\resources\views/ventas/indexEm.blade.php ENDPATH**/ ?>