       ...
       <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="container py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('devolucion.indexEm')); ?>" class="btn btn-secondary">
            ...
            <div class="table-responsive mt-4">
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $detalles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($detalle->ID_Devolucion); ?></td>
                            <td><?php echo e($detalle->Cantidad_Devuelta); ?></td>
                            <td><?php echo e($detalle->ID_Venta); ?></td>
                            <td>
                                
                                <button class="btn btn-warning btn-sm"
                                        onclick="abrirModalEditar(
                                            <?php echo e($detalle->ID_Devolucion); ?>,
                                            <?php echo e($detalle->ID_Venta); ?>,
                                            <?php echo e($detalle->Cantidad_Devuelta); ?>
                                ...
                                <button class="btn btn-danger btn-sm"
                                        ...
                                        data-bs-target="#eliminarModal<?php echo e($loop->index); ?>">
                        ...
                        <!-- Modal Eliminar -->
                        <div class="modal fade" id="eliminarModal<?php echo e($loop->index); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('detalledevolucion.destroyEm', $detalle->ID_Devolucion)); ?>">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning">
                                                <strong>ID Devolución:</strong> <?php echo e($detalle->ID_Devolucion); ?><br>
                                                <strong>Cantidad Devuelta:</strong> <?php echo e($detalle->Cantidad_Devuelta); ?><br>
            ...
            <div class="modal fade" id="crearModal">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="<?php echo e(route('detalledevolucion.storeEm')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <select name="ID_Devolucion" class="form-control mb-3" required>
                                    ...
                                    <?php $__currentLoopData = $devoluciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($dev->ID_Devolucion); ?>">
                                            ID: <?php echo e($dev->ID_Devolucion); ?>
...
<?php /**PATH C:\Users\rnico\laraveeeeee\miapp\resources\views/detalle_devoluciones/indexEm.blade.php ENDPATH**/ ?>