    ...
    <div class="barra-lateral d-flex flex-column flex-shrink-0 p-3 bg-primary text-white">
        ...
        <div class="menu-barra-lateral">
            <div class="seccion-menu">
                ...
                <a href="<?php echo e(route('devolucion.index')); ?>" class="elemento-menu activo">
    ...
    <div class="contenido-principal flex-grow-1">
        ...
        <div class="container py-4">
                ...
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $devolucion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info btn-sm" onclick="abrirDetalleModal(<?php echo e($dev->ID_Devolucion); ?>)">
                                    <i class="fa fa-eye"></i>
                                </button>
                        ...
                        <div class="modal fade" id="editarModal<?php echo e($dev->ID_Devolucion); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('devolucion.update')); ?>">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <label>Motivo</label>
                                            <textarea name="Motivo" class="form-control" rows="3" required><?php echo e($dev->Motivo); ?></textarea>
                                        </div>
                        ...
                        <div class="modal fade" id="eliminarModal<?php echo e($dev->ID_Devolucion); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('devolucion.destroy')); ?>">
            ...
            <div class="modal fade" id="crearModal">
                <div class="modal-dialog">
                    <form method="POST" action="<?php echo e(route('devolucion.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="modal-content">
...
<script>
const urlDetalleDevolucion = "<?php echo e(route('detalledevolucion.index')); ?>";
...
</html><?php /**PATH C:\Users\Kevin Morave\Music\Laravel\laravell\miapp\resources\views/devolucion/index.blade.php ENDPATH**/ ?>