...
<div class="d-flex" style="min-height:100vh">
    ...
    <div class="barra-lateral d-flex flex-column flex-shrink-0 p-3 bg-primary text-white">
        ...
        <div class="menu-barra-lateral">
            ...
            <hr>
            <div class="seccion-menu">
                <a href="<?php echo e(route('productos.index')); ?>" class="elemento-menu activo">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="modal fade" id="editarModal<?php echo e($pro['ID_Producto']); ?>">
                            <div class="modal-dialog modal-lg">
                                <form method="POST" action="<?php echo e(route('productos.update')); ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="ID_Categoria" class="form-control" required>
                                                    <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($id); ?>" <?php echo e((int)$pro['ID_Categoria']===(int)$id ? 'selected' : ''); ?>>
                                                            <?php echo e($nombre); ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="ID_Estado" class="form-control" required>
                                                    <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($id); ?>" <?php echo e((int)$pro['ID_Estado']===(int)$id ? 'selected' : ''); ?>>
                                                            <?php echo e($nombre); ?>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="ID_Gama" class="form-control" required>
                                                    <?php $__currentLoopData = $gamas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($id); ?>" <?php echo e((int)$pro['ID_Gama']===(int)$id ? 'selected' : ''); ?>>
                                                            <?php echo e($nombre); ?>
                        ...
                        <div class="modal fade" id="eliminarModal<?php echo e($pro['ID_Producto']); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('productos.destroy')); ?>">
...
<?php /**PATH C:\Users\Kevin Morave\Music\Laravel\laravell\miapp\resources\views/productos/index.blade.php ENDPATH**/ ?>