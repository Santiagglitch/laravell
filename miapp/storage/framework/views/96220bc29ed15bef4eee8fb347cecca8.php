            ...
            <div class="table-responsive mt-4">
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $compras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($compra->ID_Entrada); ?></td>
                            <td>$<?php echo e(number_format($compra->Precio_Compra, 2)); ?></td>
                            <td><?php echo e($compra->nombre_producto); ?></td>
                            <td><?php echo e($compra->Documento_Empleado); ?></td>
                            <td>
                                <button class="btn btn-info btn-sm" 
                                        onclick="abrirDetalleModal(<?php echo e($compra->ID_Entrada); ?>)">
                                    <i class="fa fa-eye"></i>
                                </button>

                                <button class="btn btn-warning btn-sm"
                                        data-bs-toggle="modal"
                                        data-bs-target="#editarModal<?php echo e($compra->ID_Entrada); ?>">
                                    <i class="fa fa-edit"></i>
                                </button>

                                <button class="btn btn-danger btn-sm"
                                        data-bs-toggle="modal"
                                        data-bs-target="#eliminarModal<?php echo e($compra->ID_Entrada); ?>">
                        ...
                        <!-- Modal Editar -->
                        <div class="modal fade" id="editarModal<?php echo e($compra->ID_Entrada); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('compras.update', $compra->ID_Entrada)); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <div class="modal-content">
                                        <div class="modal-header bg-warning">
                                            <h5 class="modal-title">Editar Compra #<?php echo e($compra->ID_Entrada); ?></h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <label>Precio Compra</label>
                                            <input name="Precio_Compra" type="number" step="0.01" class="form-control mb-3" value="<?php echo e($compra->Precio_Compra); ?>" required>
                                            ...
                                            <select name="ID_Producto" class="form-control" required>
                                                <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($prod->ID_Producto); ?>" 
                                                        <?php echo e($compra->ID_Producto == $prod->ID_Producto ? 'selected' : ''); ?>>
                                                        <?php echo e($prod->Nombre_Producto); ?>
                        ...
                        <!-- Modal Eliminar -->
                        <div class="modal fade" id="eliminarModal<?php echo e($compra->ID_Entrada); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('compras.destroy', $compra->ID_Entrada)); ?>">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning">
                                                <strong>Producto:</strong> <?php echo e($compra->nombre_producto); ?><br>
                                                <strong>Precio:</strong> $<?php echo e(number_format($compra->Precio_Compra, 2)); ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <select name="ID_Producto" class="form-control" required>
                                    ...
                                    <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($prod->ID_Producto); ?>"><?php echo e($prod->Nombre_Producto); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>

                                <input type="hidden" name="Documento_Empleado" value="<?php echo e(session('documento')); ?>">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
...
<script>
const urlDetalleCompras = "<?php echo e(route('detallecompras.index')); ?>";
...
</html><?php /**PATH C:\Users\Kevin Morave\Music\Laravel\laravell\miapp\resources\views/compras/index.blade.php ENDPATH**/ ?>