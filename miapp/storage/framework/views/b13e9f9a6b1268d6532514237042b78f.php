    ...
    <div class="barra-lateral d-flex flex-column flex-shrink-0 p-3 bg-primary text-white">
        ...
        <div class="menu-barra-lateral">
            <div class="seccion-menu">
                ...
                <a href="<?php echo e(route('ventas.index')); ?>" class="elemento-menu activo">
        ...
        <div class="container py-4">
                ...
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $detalles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><?php echo e($detalle->Fecha_Salida); ?></td>
                            <td><?php echo e($detalle->ID_Venta); ?></td>
                            <td>
                                <button class="btn btn-warning btn-sm"
                                        onclick="abrirModalEditar(
                                            <?php echo e($detalle->ID_Venta); ?>,
                                            <?php echo e($detalle->ID_Producto); ?>,
                                            <?php echo e($detalle->Cantidad); ?>,
                                            <?php echo e($detalle->Stock_Minimo); ?>
                                ...
                                <button class="btn btn-danger btn-sm"
                                        ...
                                        data-bs-target="#eliminarModal<?php echo e($detalle->ID_Producto); ?><?php echo e($detalle->ID_Venta); ?>">
                        ...
                        <div class="modal fade" id="eliminarModal<?php echo e($detalle->ID_Producto); ?><?php echo e($detalle->ID_Venta); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('detalleventas.destroy')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <input type="hidden" name="ID_Producto" value="<?php echo e($detalle->ID_Producto); ?>">
                                    <input type="hidden" name="ID_Venta" value="<?php echo e($detalle->ID_Venta); ?>">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning">
                                                <strong>Producto:</strong> <?php echo e($detalle->Nombre_Producto); ?><br>
                                                <strong>Cantidad:</strong> <?php echo e($detalle->Cantidad); ?><br>
                                                <strong>ID Venta:</strong> <?php echo e($detalle->ID_Venta); ?>

                                            </div>
                                            <div class="alert alert-info">
                                                <i class="fa fa-info-circle"></i>
                                                Al eliminar, se devolverán <strong><?php echo e($detalle->Cantidad); ?></strong> unidades al stock de <strong><?php echo e($detalle->Nombre_Producto); ?></strong>.
                                            </div>
                                        </div>
            ...
            <div class="modal fade" id="editarModal">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="<?php echo e(route('detalleventas.update')); ?>" id="formEditar">
                        <?php echo csrf_field(); ?>
            ...
            <div class="modal fade" id="crearModal">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="<?php echo e(route('detalleventas.store')); ?>" id="formCrear">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="modal-body">
                                ...
                                <div id="seccion_venta" class="d-none">
                                    ...
                                    <select name="ID_Venta" id="crear_id_venta" class="form-select" required>
                                        ...
                                        <?php $__currentLoopData = $ultimasVentas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($venta->ID_Venta); ?>">
                                                Venta #<?php echo e($venta->ID_Venta); ?> — Cliente: <?php echo e($venta->Documento_Cliente); ?>
...
function buscarProducto() {
    ...
    fetch(`/detalleventas/buscar-producto/${encodeURIComponent(nombre)}`)
        .then(r => r.json())
        .then(data => {
...
let timeoutBusqueda;
document.getElementById('buscar_producto_input').addEventListener('keyup', function(e) {
...
document.getElementById('formCrear').addEventListener('submit', function(e) {
    ...
    if (val > productoSeleccionado.stock) {
        e.preventDefault();
        alert(`⚠️ Solo hay ${productoSeleccionado.stock} unidades disponibles.`);
        return;
    }
    const venta = document.getElementById('crear_id_venta').value;
    if (!venta) {
        e.preventDefault();
        alert('⚠️ Por favor selecciona una venta.');
    }
});
...
function abrirModalEditar(idVenta, idProducto, cantidadActual, stockActual) {
    ...
    fetch(`/detalleventas/venta-info/${idVenta}`)
        .then(r => r.json())
        .then(data => {
            document.getElementById('edit_producto').textContent = data.producto || 'N/A';
...
// Validar cantidad en tiempo real en editar
...
</html><?php /**PATH C:\Users\Kevin Morave\Music\Laravel\laravell\miapp\resources\views/detalle_ventas/index.blade.php ENDPATH**/ ?>