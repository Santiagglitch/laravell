       ...
       <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="container py-4">
            ...
            <div class="table-responsive mt-4">
                <table class="table table-bordered table-striped table-hover text-center align-middle">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($emp->Documento_Empleado); ?></td>
                            <td><?php echo e($emp->Tipo_Documento); ?></td>
                            <td><?php echo e($emp->Nombre_Usuario); ?></td>
                            <td><?php echo e($emp->Apellido_Usuario); ?></td>
                            <td><?php echo e($emp->Edad); ?></td>
                            <td><?php echo e($emp->Correo_Electronico); ?></td>
                            <td><?php echo e($emp->Telefono); ?></td>
                            <td><?php echo e($emp->Genero); ?></td>
                            <td><?php echo e($emp->estado->Nombre_Estado ?? 'Sin estado'); ?></td>
                            <td><?php echo e($emp->rol->Nombre ?? 'Sin rol'); ?></td>
                            <td>
                                <?php if($emp->Fotos): ?>
                                    <?php
                                    ...
                                    ?>
                                    <img src="<?php echo e($fotoUrl); ?>" width="50" height="50" class="rounded" style="object-fit:cover;">
                                <?php else: ?>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#editarModal<?php echo e($emp->Documento_Empleado); ?>">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#eliminarModal<?php echo e($emp->Documento_Empleado); ?>">
                        ...
                        <div class="modal fade" id="editarModal<?php echo e($emp->Documento_Empleado); ?>">
                            <div class="modal-dialog modal-lg">
                                <form method="POST" action="<?php echo e(route('empleados.update')); ?>" enctype="multipart/form-data" autocomplete="off">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="Documento_Empleado" value="<?php echo e($emp->Documento_Empleado); ?>">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body row g-3">
                                            <div class="col-md-6">
                                                <label>Nombre</label>
                                                <input class="form-control" name="Nombre_Usuario" value="<?php echo e($emp->Nombre_Usuario); ?>" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Apellido</label>
                                                <input class="form-control" name="Apellido_Usuario" value="<?php echo e($emp->Apellido_Usuario); ?>" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Edad</label>
                                                <input class="form-control" name="Edad" value="<?php echo e($emp->Edad); ?>" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Correo</label>
                                                <input type="email" class="form-control" name="Correo_Electronico" value="<?php echo e($emp->Correo_Electronico); ?>" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Teléfono</label>
                                                <input class="form-control" name="Telefono" value="<?php echo e($emp->Telefono); ?>" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Tipo de documento</label>
                                                <select name="Tipo_Documento" class="form-control" required>
                                                    <option value="CC"  <?php echo e($emp->Tipo_Documento=='CC'  ? 'selected':''); ?>>Cédula de ciudadanía</option>
                                                    <option value="TI"  <?php echo e($emp->Tipo_Documento=='TI'  ? 'selected':''); ?>>Tarjeta de identidad</option>
                                                    <option value="CE"  <?php echo e($emp->Tipo_Documento=='CE'  ? 'selected':''); ?>>Cédula de extranjería</option>
                                                    <option value="PA"  <?php echo e($emp->Tipo_Documento=='PA'  ? 'selected':''); ?>>Pasaporte</option>
                                                    <option value="NIT" <?php echo e($emp->Tipo_Documento=='NIT' ? 'selected':''); ?>>NIT</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Género</label>
                                                <select name="Genero" class="form-control" required>
                                                    <option value="F" <?php echo e($emp->Genero=='F'?'selected':''); ?>>Femenino</option>
                                                    <option value="M" <?php echo e($emp->Genero=='M'?'selected':''); ?>>Masculino</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Estado</label>
                                                <select name="ID_Estado" class="form-control" required>
                                                    <option value="1" <?php echo e((int)$emp->ID_Estado===1?'selected':''); ?>>Activo</option>
                                                    <option value="2" <?php echo e((int)$emp->ID_Estado===2?'selected':''); ?>>Inactivo</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Rol</label>
                                                <select name="ID_Rol" class="form-control" required>
                                                    <option value="1" <?php echo e((int)$emp->ID_Rol===1?'selected':''); ?>>Administrador</option>
                                                    <option value="2" <?php echo e((int)$emp->ID_Rol===2?'selected':''); ?>>Empleado</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 position-relative">
                                                <label>Nueva Contraseña</label>
                                                <input type="password" name="Contrasena"
                                                       id="editarContrasena<?php echo e($emp->Documento_Empleado); ?>"
                                                ...
                                                <i class="fa fa-eye position-absolute" style="top:38px;right:10px;cursor:pointer;"
                                                   onclick="togglePassword('editarContrasena<?php echo e($emp->Documento_Empleado); ?>',this)"></i>
                        ...
                        <div class="modal fade" id="eliminarModal<?php echo e($emp->Documento_Empleado); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('empleados.destroy')); ?>">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning mt-3">
                                                <strong>Nombre:</strong> <?php echo e($emp->Nombre_Usuario); ?> <?php echo e($emp->Apellido_Usuario); ?><br>
                                                <strong>Documento:</strong> <?php echo e($emp->Documento_Empleado); ?>
            ...
            <div class="modal fade" id="crearModal">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="<?php echo e(route('empleados.store')); ?>" enctype="multipart/form-data" autocomplete="off">
                        <?php echo csrf_field(); ?>
                        <div class="modal-content">
...
<?php /**PATH C:\Users\Kevin Morave\Music\Laravel\laravell\miapp\resources\views/empleados/index.blade.php ENDPATH**/ ?>