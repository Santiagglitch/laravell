                        ...
                        <table class="table table-hover mb-0 audit-table">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $auditorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="audit-preview mono" title="<?php echo e($a->Datos_Antes ?? ''); ?>">
                                            <?php echo e($a->Datos_Antes ?? '—'); ?>

                                        </div>
                                    </td>

                                    <td>
                                        <div class="audit-preview mono" title="<?php echo e($a->Datos_Despues ?? ''); ?>">
                                            <?php echo e($a->Datos_Despues ?? '—'); ?>
                                    ...
                                    <td class="text-end">
                                        <button class="btn btn-sm btn-outline-primary"
                                                ...
                                                data-id="<?php echo e($a->ID_Auditoria); ?>"
                                                data-tabla="<?php echo e($a->Tabla_Afectada); ?>"
                                                data-op="<?php echo e($a->Operacion); ?>"
                                                data-reg="<?php echo e($a->ID_Registro); ?>"
                                                data-fecha="<?php echo e($a->Fecha); ?>"
                                                data-antes="<?php echo e(e($a->Datos_Antes ?? '')); ?>"
                                                data-despues="<?php echo e(e($a->Datos_Despues ?? '')); ?>">
                                            Ver
                                        </button>
                                    </td>
                                </tr>
                ...
                <div class="card-footer bg-white">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div class="small-muted">
                            Mostrando <?php echo e($auditorias->count()); ?> registros en esta página.
                        </div>
                        <div>
                            <?php echo e($auditorias->withQueryString()->links()); ?>
...
<?php /**PATH C:\Users\Kevin Morave\Music\Laravel\laravell\miapp\resources\views/auditoria/index.blade.php ENDPATH**/ ?>