    ...
    <div class="barra-lateral d-flex flex-column flex-shrink-0 p-3 bg-primary text-white">
        ...
        <div class="menu-barra-lateral">
            ...
            <div class="seccion-menu">
                ...
                <a href="<?php echo e(route('proveedor.index')); ?>" class="elemento-menu activo">
        ...
        <div class="container py-4">
            ...
            <div class="table-responsive mt-4">
                <table class="table table-bordered table-hover table-striped align-middle text-center">
                    ...
                    <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($prov->ID_Proveedor); ?></td>
                            <td><?php echo e($prov->Nombre_Proveedor); ?></td>
                            <td><?php echo e($prov->Correo_Electronico); ?></td>
                            <td><?php echo e($prov->Telefono); ?></td>
                            <td>
                                <?php if($prov->ID_Estado == 1): ?>
                                    <span class="badge bg-success">Activo</span>
                                <?php elseif($prov->ID_Estado == 2): ?>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#editar<?php echo e($prov->ID_Proveedor); ?>">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#eliminar<?php echo e($prov->ID_Proveedor); ?>">
                        ...
                        <div class="modal fade" id="editar<?php echo e($prov->ID_Proveedor); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('proveedor.update')); ?>">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="ID_Proveedor" value="<?php echo e($prov->ID_Proveedor); ?>">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input class="form-control mb-3" name="Nombre_Proveedor"
                                                   value="<?php echo e($prov->Nombre_Proveedor); ?>" required>
                                            <label>Correo</label>
                                            <input type="email" class="form-control mb-3" name="Correo_Electronico"
                                                   value="<?php echo e($prov->Correo_Electronico); ?>" required>
                                            <label>Teléfono</label>
                                            <input class="form-control mb-3" name="Telefono"
                                                   value="<?php echo e($prov->Telefono); ?>" required>
                                            <label>Estado</label>
                                            <select name="ID_Estado" class="form-control" required>
                                                <option value="1" <?php echo e($prov->ID_Estado==1?'selected':''); ?>>Activo</option>
                                                <option value="2" <?php echo e($prov->ID_Estado==2?'selected':''); ?>>Inactivo</option>
                                                <option value="3" <?php echo e($prov->ID_Estado==3?'selected':''); ?>>En proceso</option>
                                            </select>
                                        </div>
                        ...
                        <div class="modal fade" id="eliminar<?php echo e($prov->ID_Proveedor); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('proveedor.destroy')); ?>">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning">
                                                <strong>Nombre:</strong> <?php echo e($prov->Nombre_Proveedor); ?><br>
                                                <strong>Correo:</strong> <?php echo e($prov->Correo_Electronico); ?><br>
                                                <strong>Teléfono:</strong> <?php echo e($prov->Telefono); ?>
...
<?php /**PATH C:\Users\Kevin Morave\Music\Laravel\laravell\miapp\resources\views/proveedor/index.blade.php ENDPATH**/ ?>