                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo e($prov->estado->Nombre_Estado ?? 'Sin estado'); ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="email" class="form-control mb-3" name="Correo_Electronico"
                                                   value="<?php echo e($prov->Correo_Electronico); ?>">

                                            <label>Teléfono</label>
                                            <input class="form-control mb-3" name="Telefono"
                                                   value="<?php echo e($prov->Telefono); ?>">

                                            <label>Estado <span class="text-danger">*</span></label>
                                            <select name="ID_Estado" class="form-control" required>
                                                <option value="1" <?php echo e((int)$prov->ID_Estado===1?'selected':''); ?>>Activo</option>
                                                <option value="2" <?php echo e((int)$prov->ID_Estado===2?'selected':''); ?>>Inactivo</option>
                                                <option value="3" <?php echo e((int)$prov->ID_Estado===3?'selected':''); ?>>En proceso</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning">
                                                <strong>ID:</strong> <?php echo e($prov->ID_Proveedor); ?><br>
                                                <strong>Nombre:</strong> <?php echo e($prov->Nombre_Proveedor); ?><br>
                                                <strong>Correo:</strong> <?php echo e($prov->Correo_Electronico); ?>
...
<?php /**PATH C:\Users\rnico\laraveeeeee\miapp\resources\views/proveedor/index.blade.php ENDPATH**/ ?>