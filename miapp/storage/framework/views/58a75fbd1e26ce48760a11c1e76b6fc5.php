        ...
        <div class="container py-4">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $ventas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#eliminarModal<?php echo e($venta->ID_Venta); ?>">
                                    <i class="fa fa-trash"></i>
                                </button>
                            </td>
                        </tr>
                        <div class="modal fade" id="eliminarModal<?php echo e($venta->ID_Venta); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('ventas.destroy')); ?>">
            ...
            <div class="modal fade" id="crearModal" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="<?php echo e(route('ventas.store')); ?>" id="formVenta">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="Documento_Empleado" class="form-select" required>
                                        ...
                                        <?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($emp->Documento_Empleado); ?>"
                                                <?php echo e(session('documento') == $emp->Documento_Empleado ? 'selected' : ''); ?>>
                                                <?php echo e($emp->Nombre_Usuario); ?> <?php echo e($emp->Apellido_Usuario); ?>

                                                (<?php echo e($emp->Documento_Empleado); ?>)
                                            </option>
...
<script>
const urlDetalleVentas = "<?php echo e(route('detalleventas.index')); ?>";
...
</html><?php /**PATH C:\Users\Kevin Morave\Music\Laravel\laravell\miapp\resources\views/ventas/index.blade.php ENDPATH**/ ?>