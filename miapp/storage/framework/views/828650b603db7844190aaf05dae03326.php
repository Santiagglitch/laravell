    ...
    <div class="contenido-principal flex-grow-1">
        ...
        <div class="container py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('ventas.indexEm')); ?>" class="btn btn-secondary">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $detalles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="modal fade" id="eliminarModal<?php echo e($detalle->ID_Producto); ?><?php echo e($detalle->ID_Venta); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('detalleventas.destroyEm')); ?>">
                                    <?php echo csrf_field(); ?>
            ...
            <div class="modal fade" id="editarModal">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="<?php echo e(route('detalleventas.updateEm')); ?>" id="formEditar">
                        <?php echo csrf_field(); ?>
            ...
            <div class="modal fade" id="crearModal">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="<?php echo e(route('detalleventas.storeEm')); ?>" id="formCrear">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\rnico\laraveeeeee\miapp\resources\views/detalle_ventas/indexEm.blade.php ENDPATH**/ ?>