       ...
       <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="container py-4">
            ...
            <div class="table-responsive mt-4">
                <table class="table table-bordered table-hover table-striped align-middle text-center">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cli): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($cli->Documento_Cliente); ?></td>
                            <td><?php echo e($cli->Nombre_Cliente); ?></td>
                            <td><?php echo e($cli->Apellido_Cliente); ?></td>
                            <td>
                                <?php if($cli->ID_Estado == 1): ?>
                                    Activo
                                <?php else: ?>
                                    Inactivo
                                <?php endif; ?>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#editar<?php echo e($cli->Documento_Cliente); ?>">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#eliminar<?php echo e($cli->Documento_Cliente); ?>">
                        ...
                        <!-- MODAL EDITAR -->
                        <div class="modal fade" id="editar<?php echo e($cli->Documento_Cliente); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('clientes.updateEm')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="Documento_Cliente" value="<?php echo e($cli->Documento_Cliente); ?>">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input class="form-control mb-3" name="Documento_Cliente"
                                                   value="<?php echo e($cli->Documento_Cliente); ?>" readonly>

                                            <label>Nombre</label>
                                            <input class="form-control mb-3" name="Nombre_Cliente"
                                                   value="<?php echo e($cli->Nombre_Cliente); ?>" required>

                                            <label>Apellido</label>
                                            <input class="form-control mb-3" name="Apellido_Cliente"
                                                   value="<?php echo e($cli->Apellido_Cliente); ?>" required>

                                            <label>Estado</label>
                                            <select name="ID_Estado" class="form-control" required>
                                                <option value="1" <?php echo e($cli->ID_Estado==1?'selected':''); ?>>Activo</option>
                                                <option value="2" <?php echo e($cli->ID_Estado==2?'selected':''); ?>>Inactivo</option>
                                            </select>
                                        </div>
                        ...
                        <!-- MODAL ELIMINAR -->
                        <div class="modal fade" id="eliminar<?php echo e($cli->Documento_Cliente); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('clientes.destroyEm')); ?>">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning">
                                                <strong>Documento:</strong> <?php echo e($cli->Documento_Cliente); ?><br>
                                                <strong>Nombre:</strong> <?php echo e($cli->Nombre_Cliente); ?> <?php echo e($cli->Apellido_Cliente); ?>
            ...
            <div class="modal fade" id="crearModal">
                <div class="modal-dialog">
                    <form method="POST" action="<?php echo e(route('clientes.storeEm')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="modal-content">
...
async function iniciarExportacion() {
    ...
    try {
        ...
        const info = XLSX.utils.aoa_to_sheet([
            ...
            ['Generado por:', '<?php echo e(session("nombre") ?? "TECNICELL RM"); ?>']
        ]);
...
</html><?php /**PATH C:\Users\rnico\laraveeeeee\miapp\resources\views/clientes/indexEm.blade.php ENDPATH**/ ?>