    ...
    <div class="barra-lateral d-flex flex-column flex-shrink-0 p-3 bg-primary text-white">
        ...
        <div class="menu-barra-lateral">
            <div class="seccion-menu">
                ...
                <a href="<?php echo e(route('ventas.indexEm')); ?>" class="elemento-menu">
            ...
            <div class="seccion-menu">
                ...
                <a href="<?php echo e(route('clientes.indexEm')); ?>" class="elemento-menu activo">
    ...
    <div class="contenido-principal flex-grow-1">
        ...
        <div class="container py-4">
            ...
            <div class="table-responsive mt-4">
                <table class="table table-bordered table-striped table-hover text-center">
                    ...
                    <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($pro['ID_Producto']); ?></td>
                            <td><?php echo e($pro['Nombre_Producto']); ?></td>
                            <td><?php echo e($pro['Descripcion']); ?></td>
                            <td><?php echo e($pro['Precio_Venta']); ?></td>
                            <td><?php echo e($pro['Stock_Minimo']); ?></td>
                            <td><?php echo e($pro['Categoria'] ?? $pro['ID_Categoria']); ?></td>
                            <td><?php echo e($pro['Estado'] ?? $pro['ID_Estado']); ?></td>
                            <td><?php echo e($pro['Gama'] ?? $pro['ID_Gama']); ?></td>
                            <td>
                                <?php if(!empty($pro['Fotos'])): ?>
                                    <?php
                                        $foto = $pro['Fotos'];
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#editarModal<?php echo e($pro['ID_Producto']); ?>">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#eliminarModal<?php echo e($pro['ID_Producto']); ?>">
                        ...
                        <!-- MODAL EDITAR -->
                        <div class="modal fade" id="editarModal<?php echo e($pro['ID_Producto']); ?>">
                            <div class="modal-dialog modal-lg">
                                <form method="POST" action="<?php echo e(route('productos.updateEm')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="ID_Producto" value="<?php echo e($pro['ID_Producto']); ?>">
                                    <div class="modal-content">
                                        <div class="modal-header bg-warning">
                                            <h5 class="modal-title">Editar Producto #<?php echo e($pro['ID_Producto']); ?></h5>
                                        ...
                                        <div class="modal-body row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" name="Nombre_Producto"
                                                       value="<?php echo e($pro['Nombre_Producto']); ?>" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Precio Venta</label>
                                                <input class="form-control" name="Precio_Venta"
                                                       value="<?php echo e($pro['Precio_Venta']); ?>" required>
                                            </div>
                                            <div class="col-md-12">
                                                <label>Descripción</label>
                                                <textarea class="form-control" name="Descripcion" required><?php echo e($pro['Descripcion']); ?></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <label>Stock Mínimo</label>
                                                <input class="form-control" name="Stock_Minimo"
                                                       value="<?php echo e($pro['Stock_Minimo']); ?>" required>
                                            </div>
                                            <div class="col-md-6">
                        ...
                        <!-- MODAL ELIMINAR -->
                        <div class="modal fade" id="eliminarModal<?php echo e($pro['ID_Producto']); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('productos.destroyEm')); ?>">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="alert alert-warning mt-3">
                                                <strong>Nombre:</strong> <?php echo e($pro['Nombre_Producto']); ?><br>
                                                <strong>Precio:</strong> <?php echo e($pro['Precio_Venta']); ?>
       ...
       <!-- Modal Crear -->
            <div class="modal fade" id="crearModal">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="<?php echo e(route('productos.storeEm')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="modal-content">
                            ...
                            <div class="modal-body row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="ID_Gama" class="form-control" required>
                                        <option value="">--Seleccione--</option>
                                        <?php $__currentLoopData = $gamas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $nombre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($id); ?>"><?php echo e($nombre); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
...
</html><?php /**PATH C:\Users\rnico\laraveeeeee\miapp\resources\views/productos/indexEm.blade.php ENDPATH**/ ?>