...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000" data-bs-pause="false">
        ...
        <div class="position-absolute top-0 end-0 p-3" style="z-index: 10;">
            <a href="<?php echo e(route('login.form')); ?>" class="btn btn-primary" style="background-color: #778ee9;">Iniciar sesión</a>
        </div>
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo e(asset('Imagenes/Portada.jpg')); ?>" class="d-block w-100" style="height:300px; object-fit:cover">
            </div>
            <div class="carousel-item">
                <img src="<?php echo e(asset('Imagenes/Portada 2.jpg')); ?>" class="d-block w-100" style="height:300px; object-fit:cover">
            </div>
            <div class="carousel-item">
                <img src="<?php echo e(asset('Imagenes/Portada 3.jpg')); ?>" class="d-block w-100" style="height:300px; object-fit:cover">
            </div>
            <div class="carousel-item">
                <img src="<?php echo e(asset('Imagenes/portada 4.jpg')); ?>" class="d-block w-100" style="height:300px; object-fit:cover">
            </div>
            <div class="carousel-item">
                <img src="<?php echo e(asset('Imagenes/portada 5.jpg')); ?>" class="d-block w-100" style="height:300px; object-fit:cover">
            </div>
        </div>
    ...
    <header class="header">
        <div class="menu container">
            <img src="<?php echo e(asset('Imagenes/Logo.webp')); ?>" alt="Logo" class="logo">
        </div>
    </header>
    ...
    <div class="container text-center card mb-3">
        <div class="row g-0">
            <div class="col-md-4">
                <img src="<?php echo e(asset('Imagenes/Logo.webp')); ?>" class="img-fluid rounded-start">
            </div>
            <div class="col-md-8">
                <div class="card-body">
    ...
    <div class="container text-center">
        ...
        <div class="celulares group">
            <div class="celular">
                <img src="<?php echo e(asset('Imagenes/Redmi.jpg')); ?>">
                <h3>iPhone 15</h3>
                <p>Pantalla OLED, cámara 48 MP, chip A16, USB-C.</p>
            </div>

            <div class="celular">
                <img src="<?php echo e(asset('Imagenes/Iphone32.jpg')); ?>">
                <h3>Redmi 13</h3>
                <p>Helio G91, 8 GB RAM, 256 GB.</p>
            </div>

            <div class="celular">
                <img src="<?php echo e(asset('Imagenes/Samsung.jpg')); ?>">
    ...
    <div class="container text-center">
        ...
        <div class="accesorios-container">
            <div class="accesorio">
                <img src="<?php echo e(asset('Imagenes/Forros para celular.jpg')); ?>">
                <h3>Forros</h3>
                <p>Silicona, cuero y reforzados.</p>
            </div>

            <div class="accesorio">
                <img src="<?php echo e(asset('Imagenes/Audífonos.jpg')); ?>">
                <h3>Audífonos</h3>
                <p>Bluetooth y con micrófono.</p>
            </div>

            <div class="accesorio">
                <img src="<?php echo e(asset('Imagenes/Cargadores.jpg')); ?>">
                <h3>Cargadores</h3>
    ...
    <div class="container">
        <div class="footer-row">
            ...
            <div class="Fonrio">
                <h4>Fonrio</h4>
                <ul>
                    <li><a href="<?php echo e(route('pie.pag')); ?>#quienes-somos">¿Quiénes somos?</a></li>
                    <li><a href="<?php echo e(route('pie.pag')); ?>#porque-fonrio">¿Por qué Fonrio?</a></li>
                    <li><a href="<?php echo e(route('pie.pag')); ?>#politica-privacidad">Política de privacidad</a></li>
                </ul>
            </div>
            ...
            <div class="Ayuda">
                <h4>Ayuda</h4>
                <ul>
                    <li><a href="<?php echo e(route('pie.pag')); ?>#preguntas-frecuentes">Preguntas frecuentes</a></li>
                </ul>
            </div>
            ...
            <div class="Tienda">
                <h4>Tienda</h4>
                <ul>
                    <li><a href="<?php echo e(route('pie.pag')); ?>#celulares">Celulares</a></li>
                    <li><a href="<?php echo e(route('pie.pag')); ?>#accesorio">Accesorios</a></li>
                    <li><a href="<?php echo e(route('pie.pag')); ?>#Integrantes">Integrantes</a></li>
                </ul>
            </div>
...
</footer><?php /**PATH C:\Users\Kevin Morave\Music\Laravel\laravell\miapp\resources\views/inicio.blade.php ENDPATH**/ ?>