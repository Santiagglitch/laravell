    ...
    <div class="contenido-principal flex-grow-1">
        ...
        <div class="container py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="<?php echo e(route('devolucion.index')); ?>" class="btn btn-secondary">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $detalles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="modal fade" id="eliminarModal<?php echo e($loop->index); ?>">
                            <div class="modal-dialog">
                                <form method="POST" action="<?php echo e(route('detalledevolucion.destroy', $detalle->ID_Devolucion)); ?>">
                                    <?php echo csrf_field(); ?>
            ...
            <div class="modal fade" id="crearModal">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="<?php echo e(route('detalledevolucion.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="modal-content">
                                ...
                                <select name="ID_Devolucion" class="form-control mb-3" required>
                                    ...
                                    <?php $__currentLoopData = $devoluciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($dev->ID_Devolucion); ?>">
                                            ID: <?php echo e($dev->ID_Devolucion); ?> - <?php echo e($dev->Motivo ?? ''); ?>
...
<?php /**PATH C:\Users\Kevin Morave\Music\Laravel\laravell\miapp\resources\views/detalle_devoluciones/index.blade.php ENDPATH**/ ?>