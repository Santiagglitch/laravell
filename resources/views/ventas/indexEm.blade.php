        ...
        <div class="container py-4">
                ...
                <table class="table table-bordered table-striped table-hover text-center">
                    <thead class="table-dark">
                        <tr>
                            <th>ID Venta</th>
                            <th>Doc. Cliente</th>
                            <th class="col-ocultar-sm">Doc. Empleado</th>
                            <th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                    @forelse($ventas as $venta)
                        <tr>
                            ...
                            <td class="col-ocultar-sm">{{ $venta->Documento_Empleado }}</td>
                            <td>
            ...
            <div class="modal fade" id="crearModal" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <form method="POST" action="{{ route('ventas.storeEm') }}" id="formVenta">
                        @csrf
                        <input type="hidden" name="cliente_nuevo" id="clienteNuevo" value="0">
                        <div class="modal-content">
                            <div class="modal-header bg-success text-white">
                                <h5 class="modal-title"><i class="fa fa-plus-circle"></i> Registrar Nueva Venta</h5>
                                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                            </div>
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label class="form-label fw-bold"><i class="fa fa-user"></i> Documento del Cliente</label>
                                    ...
                                    <small class="text-muted"><i class="fa fa-info-circle"></i> Ingrese el documento y espere 1 segundo o presione Enter</small>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold"><i class="fa fa-user-tie"></i> Empleado que realiza la venta</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-success" id="btnGuardar"><i class="fa fa-save"></i> Guardar Venta</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<div style="position: fixed; bottom: 0; left: 0; width: 100%; text-align: center; margin-left: 115px; padding: 6px 0;">
...
<script>
    ...
    function abrirDetalleModal(idVenta) {
        ...
        fetch(`/empleado/ventas/${idVenta}/detalles`)
            ...
            venta.detalles.forEach(detalle => {
                detallesHTML += `
                    <tr>
                        ...
                        <td class="py-3 text-center"><a href="${urlDetalleVentas}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i> Editar</a></td>
                    </tr>`;
            });
        } else {
            detallesHTML = '<tr><td colspan="4" class="text-center text-muted py-5"><i class="fa fa-inbox fa-3x mb-3 d-block"></i><p>No hay detalles registrados</p></td></tr>';
        }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function mostrarClienteEncontrado(cliente) {
            ...
            mensajeCliente.innerHTML = `<i class="fa fa-check-circle"></i> <strong>Cliente encontrado:</strong> ${cliente.Nombre_Cliente} ${cliente.Apellido_Cliente} ${cliente.ID_Estado == '1' ? '<span class="badge bg-success">Activo</span>' : '<span class="badge bg-secondary">Inactivo</span>'}`;
        ...
        function mostrarFormularioNuevo() {
            ...
            mensajeCliente.innerHTML = `<i class="fa fa-exclamation-triangle"></i> <strong>Cliente no encontrado.</strong> Complete los datos para registrar un nuevo cliente:`;
            mensajeCliente.classList.remove('d-none');
